...
func RegisterRSMProxy(node *rsm.Node) {
	node.RegisterProxy(Type, func(server *grpc.Server, client *rsm.Client) {
		api.RegisterLeaderLatchServiceServer(server, &RSMProxy{
...
func (s *RSMProxy) Latch(ctx context.Context, request *api.LatchRequest) (*api.LatchResponse, error) {
...
func (s *RSMProxy) Events(request *api.EventRequest, srv api.LeaderLatchService_EventsServer) error {
