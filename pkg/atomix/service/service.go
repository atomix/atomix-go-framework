...
type StateMachine interface {
	...
	CommandStream(bytes []byte, stream Stream, f func(error))
	...
	QueryStream(bytes []byte, stream Stream, f func(error))
}
...
type Executor interface {
	...
	Register(op string, callback func([]byte, func([]byte, error)))
	...
	RegisterStream(op string, callback func([]byte, Stream, func(error)))
...
func (e *executor) Register(op string, callback func([]byte, func([]byte, error))) {
...
func (e *executor) RegisterStream(op string, callback func([]byte, Stream, func(error))) {
...
func (s *primitiveStateMachine) CommandStream(bytes []byte, stream Stream, callback func(error)) {
	request := &ServiceRequest{}
	err := proto.Unmarshal(bytes, request)
	if err != nil {
		callback(err)
...
func (s *primitiveStateMachine) QueryStream(bytes []byte, stream Stream, callback func(error)) {
	request := &ServiceRequest{}
	err := proto.Unmarshal(bytes, request)
	if err != nil {
		callback(err)
