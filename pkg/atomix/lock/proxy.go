...
func RegisterRSMProxy(node *rsm.Node) {
	node.RegisterProxy(Type, func(server *grpc.Server, client *rsm.Client) {
		api.RegisterLockServiceServer(server, &RSMProxy{
...
func (s *RSMProxy) Lock(ctx context.Context, request *api.LockRequest) (*api.LockResponse, error) {
...
func (s *RSMProxy) Unlock(ctx context.Context, request *api.UnlockRequest) (*api.UnlockResponse, error) {
...
func (s *RSMProxy) IsLocked(ctx context.Context, request *api.IsLockedRequest) (*api.IsLockedResponse, error) {
