...
type GossipClient interface {
	...
	Repair(ctx context.Context, value *_map.Entry) (*_map.Entry, error)
	Advertise(ctx context.Context, value *_map.Entry) error
	Update(ctx context.Context, value *_map.Entry) error
}
...
func (p *gossipGroup) Bootstrap(ctx context.Context, ch chan<- _map.Entry) error {
...
func (p *gossipGroup) Repair(ctx context.Context, state *_map.Entry) (*_map.Entry, error) {
	objects, err := p.group.Read(ctx, state.Key.Key)
	if err != nil {
		return nil, err
	}

	for _, object := range objects {
		if meta.FromProto(object.ObjectMeta).After(meta.FromProto(state.Key.ObjectMeta)) {
...
func (p *gossipGroup) Advertise(ctx context.Context, state *_map.Entry) error {
	peers := p.group.Peers()
	peer := peers[rand.Intn(len(peers))]
	peer.Advertise(ctx, state.Key.Key, meta.FromProto(state.Key.ObjectMeta))
	return nil
}

func (p *gossipGroup) Update(ctx context.Context, state *_map.Entry) error {
...
func (p *gossipMember) Bootstrap(ctx context.Context, ch chan<- _map.Entry) error {
	objectCh := make(chan gossip.Object)
...
func (p *gossipMember) Repair(ctx context.Context, state *_map.Entry) (*_map.Entry, error) {
	object, err := p.peer.Read(ctx, state.Key.Key)
	if err != nil {
		return nil, err
	}
...
func (p *gossipMember) Advertise(ctx context.Context, state *_map.Entry) error {
	p.peer.Advertise(ctx, "", meta.FromProto(state.Key.ObjectMeta))
	return nil
}

func (p *gossipMember) Update(ctx context.Context, state *_map.Entry) error {
	bytes, err := proto.Marshal(state)
	if err != nil {
		return err
	}
