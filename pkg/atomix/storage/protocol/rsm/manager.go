...
func NewManager(cluster cluster.Cluster, registry *Registry, sessionTimeout time.Duration) *Manager {
...
type stateManager struct {
	...
	services       map[ServiceID]*serviceManager
...
func (m *stateManager) applySessionCommand(request *SessionCommandRequest, session *sessionManager, stream streams.WriteStream) {
...
func (m *stateManager) applyServiceCommand(request ServiceCommandRequest, context SessionCommandContext, sessionManager *sessionManager, stream streams.WriteStream) {
...
func (m *stateManager) applyServiceCommandOperation(request ServiceCommandRequest, context SessionCommandContext, sessionManager *sessionManager, stream streams.WriteStream) {
...
func (m *stateManager) applyServiceCommandCreate(request ServiceCommandRequest, context SessionCommandContext, sessionManager *sessionManager, stream streams.WriteStream) {
	defer stream.Close()
...
func (m *stateManager) applyServiceCommandClose(request ServiceCommandRequest, context SessionCommandContext, sessionManager *sessionManager, stream streams.WriteStream) {
	serviceID := ServiceID(request.Service)
...
func (m *stateManager) applyServiceCommandDelete(request ServiceCommandRequest, context SessionCommandContext, session *sessionManager, stream streams.WriteStream) {
	defer stream.Close()
...
func (m *stateManager) applyServiceQuery(request ServiceQueryRequest, context SessionQueryContext, sessionManager *sessionManager, stream streams.WriteStream) {
	switch request.Request.(type) {
...
func (m *stateManager) applyServiceQueryOperation(request ServiceQueryRequest, context SessionQueryContext, session *sessionManager, stream streams.WriteStream) {
...
func (m *stateManager) applyServiceQueryMetadata(request ServiceQueryRequest, context SessionQueryContext, session *sessionManager, stream streams.WriteStream) {
	defer stream.Close()
