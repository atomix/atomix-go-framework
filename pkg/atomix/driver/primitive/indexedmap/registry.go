...
type ProxyRegistry struct {
	proxies map[driverapi.ProxyId]indexedmap.IndexedMapServiceServer
	mu      sync.RWMutex
}

func (r *ProxyRegistry) AddProxy(id driverapi.ProxyId, server indexedmap.IndexedMapServiceServer) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *ProxyRegistry) GetProxy(id driverapi.ProxyId) (indexedmap.IndexedMapServiceServer, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
