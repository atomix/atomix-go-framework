...
func RegisterRSMProxy(node *rsm.Node) {
	node.RegisterProxy(Type, func(server *grpc.Server, client *rsm.Client) {
		api.RegisterLeaderElectionServiceServer(server, &RSMProxy{
			Proxy: rsm.NewProxy(client),
		})
	})
}

// RSMProxy is an implementation of LeaderElectionServiceServer for the election primitive
type RSMProxy struct {
	*rsm.Proxy
}

// Enter enters a candidate in the election
func (s *RSMProxy) Enter(ctx context.Context, request *api.EnterRequest) (*api.EnterResponse, error) {
...
func (s *RSMProxy) Withdraw(ctx context.Context, request *api.WithdrawRequest) (*api.WithdrawResponse, error) {
...
func (s *RSMProxy) Anoint(ctx context.Context, request *api.AnointRequest) (*api.AnointResponse, error) {
...
func (s *RSMProxy) Promote(ctx context.Context, request *api.PromoteRequest) (*api.PromoteResponse, error) {
...
func (s *RSMProxy) Evict(ctx context.Context, request *api.EvictRequest) (*api.EvictResponse, error) {
...
func (s *RSMProxy) GetTerm(ctx context.Context, request *api.GetTermRequest) (*api.GetTermResponse, error) {
...
func (s *RSMProxy) Events(request *api.EventRequest, srv api.LeaderElectionService_EventsServer) error {
