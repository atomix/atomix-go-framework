...
func TestLog(t *testing.T) {
	...
	_log, err := client.New(context.TODO(), name, []net.Address{address}, session.WithTimeout(5*time.Second))
...
func TestLogStreams(t *testing.T) {
	...
	log1, err := client.New(context.TODO(), name, []net.Address{address}, session.WithTimeout(5*time.Second))
	assert.NoError(t, err)

	log2, err := client.New(context.TODO(), name, []net.Address{address}, session.WithTimeout(5*time.Second))
	assert.NoError(t, err)
