...
import (
	"io"
	"fmt"
	{{ import "github.com/atomix/atomix-go-sdk/pkg/atomix/storage/protocol/rsm" }}
	{{ import "github.com/atomix/atomix-go-sdk/pkg/atomix/util" }}
	{{ import "github.com/golang/protobuf/proto" }}
	{{- range .Primitive.Methods }}
	{{- if ( or .Response.IsStream .Type.IsAsync ) }}
	{{ import "github.com/atomix/atomix-go-sdk/pkg/atomix/errors" }}
	{{- end }}
	{{- end }}
	{{- $package := .Package }}
	{{- range .Imports }}
