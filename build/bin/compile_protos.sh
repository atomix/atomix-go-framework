...
protoc -I=$proto_imports --gogofaster_out=$go_import_paths,Matomix/storage/protocol/gossip/primitive/extensions.proto=github.com/atomix/atomix-go-sdk/pkg/atomix/storage/protocol/gossip/primitive,import_path=atomix/storage/protocol/gossip/counter,plugins=grpc:pkg pkg/atomix/storage/protocol/gossip/counter/*.proto
protoc -I=$proto_imports --gogofaster_out=$go_import_paths,Matomix/storage/protocol/gossip/primitive/extensions.proto=github.com/atomix/atomix-go-sdk/pkg/atomix/storage/protocol/gossip/primitive,import_path=atomix/storage/protocol/gossip/map,plugins=grpc:pkg     pkg/atomix/storage/protocol/gossip/map/*.proto
protoc -I=$proto_imports --gogofaster_out=$go_import_paths,Matomix/storage/protocol/gossip/primitive/extensions.proto=github.com/atomix/atomix-go-sdk/pkg/atomix/storage/protocol/gossip/primitive,import_path=atomix/storage/protocol/gossip/set,plugins=grpc:pkg     pkg/atomix/storage/protocol/gossip/set/*.proto
protoc -I=$proto_imports --gogofaster_out=$go_import_paths,Matomix/storage/protocol/gossip/primitive/extensions.proto=github.com/atomix/atomix-go-sdk/pkg/atomix/storage/protocol/gossip/primitive,import_path=atomix/storage/protocol/gossip/value,plugins=grpc:pkg   pkg/atomix/storage/protocol/gossip/value/*.proto
