...
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/counter,output_path=atomix/proxy/passthrough/counter,plugin=proxy,protocol=passthrough:pkg       /go/src/github.com/atomix/api/proto/atomix/primitive/counter/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/election,output_path=atomix/proxy/passthrough/election,plugin=proxy,protocol=passthrough:pkg     /go/src/github.com/atomix/api/proto/atomix/primitive/election/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/indexedmap,output_path=atomix/proxy/passthrough/indexedmap,plugin=proxy,protocol=passthrough:pkg /go/src/github.com/atomix/api/proto/atomix/primitive/indexedmap/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/leader,output_path=atomix/proxy/passthrough/leader,plugin=proxy,protocol=passthrough:pkg         /go/src/github.com/atomix/api/proto/atomix/primitive/leader/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/list,output_path=atomix/proxy/passthrough/list,plugin=proxy,protocol=passthrough:pkg             /go/src/github.com/atomix/api/proto/atomix/primitive/list/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/lock,output_path=atomix/proxy/passthrough/lock,plugin=proxy,protocol=passthrough:pkg             /go/src/github.com/atomix/api/proto/atomix/primitive/lock/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/log,output_path=atomix/proxy/passthrough/log,plugin=proxy,protocol=passthrough:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/log/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/map,output_path=atomix/proxy/passthrough/map,plugin=proxy,protocol=passthrough:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/map/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/set,output_path=atomix/proxy/passthrough/set,plugin=proxy,protocol=passthrough:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/set/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/value,output_path=atomix/proxy/passthrough/value,plugin=proxy,protocol=passthrough:pkg           /go/src/github.com/atomix/api/proto/atomix/primitive/value/*.proto
...
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/counter,output_path=atomix/proxy/p2p/counter,plugin=proxy,protocol=p2p:pkg /go/src/github.com/atomix/api/proto/atomix/primitive/counter/*.proto
...
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/counter,output_path=atomix/protocol/p2p/counter,plugin=protocol,protocol=p2p:pkg /go/src/github.com/atomix/api/proto/atomix/primitive/counter/*.proto
...
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/indexedmap,output_path=atomix/client/indexedmap,plugin=client:pkg /go/src/github.com/atomix/api/proto/atomix/primitive/indexedmap/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/leader,output_path=atomix/client/leader,plugin=client:pkg         /go/src/github.com/atomix/api/proto/atomix/primitive/leader/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/list,output_path=atomix/client/list,plugin=client:pkg             /go/src/github.com/atomix/api/proto/atomix/primitive/list/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/lock,output_path=atomix/client/lock,plugin=client:pkg             /go/src/github.com/atomix/api/proto/atomix/primitive/lock/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/log,output_path=atomix/client/log,plugin=client:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/log/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/map,output_path=atomix/client/map,plugin=client:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/map/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/set,output_path=atomix/client/set,plugin=client:pkg               /go/src/github.com/atomix/api/proto/atomix/primitive/set/*.proto
protoc -I=$proto_path --atomix_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/primitive/value,output_path=atomix/client/value,plugin=client:pkg           /go/src/github.com/atomix/api/proto/atomix/primitive/value/*.proto
