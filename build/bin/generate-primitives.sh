...
go_import_paths="${go_import_paths},Matomix/protocol/gossip/primitive/extensions.proto=github.com/atomix/go-framework/pkg/atomix/protocol/gossip/primitive"
